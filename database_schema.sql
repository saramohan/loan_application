...
CREATE TABLE `loan_application` (
  ...
  `requested_loan_amount` float(13,2) NOT NULL,
...
CREATE TABLE `loan_details` (
  ...
  `loan_amount` float(13,2) NOT NULL,
...
CREATE TABLE `repayment_calendar` (
  ...
  `amount_due` float(13,2) NOT NULL DEFAULT '0.00',
  `amount_paid` float(13,2) NOT NULL DEFAULT '0.00',
